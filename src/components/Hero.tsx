      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl mb-12 text-muted-foreground font-light max-w-4xl mx-auto leading-relaxed fade-in-up delay-300">
            <span className="inline-block bg-gradient-to-r from-primary to-accent text-primary-foreground px-3 py-1 rounded-full font-medium text-lg md:text-xl mr-2 animate-pulse">Audio-first</span>
            translation for students who can't read yet. Real-time support with text simplification, teacher communication, and academic glossaries. Built for <span className="inline-block bg-gradient-to-r from-accent to-primary text-primary-foreground px-3 py-1 rounded-full font-medium">preliterate SLIFE students</span> who need to hear content, not just see it.
          </p>
