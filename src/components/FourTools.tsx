import { Languages, FileText, MessageSquare, BookOpen } from "lucide-react";

export const FourTools = () => {
  return (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-card border-2 border-border rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-foreground">Smart Translation with Audio</h3>
                </div>
              </div>
            ...
            <div className="bg-card border-2 border-border rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-start gap-4 mb-4">
                <div className="bg-peach p-4 rounded-full">
                  <FileText className="w-8 h-8 text-burnt-orange" />
                </div>
                <div>
                  <div className="text-primary font-semibold text-sm mb-1">Tool #2</div>
                  <h3 className="text-2xl font-bold text-foreground">Text Simplification</h3>
                </div>
              </div>
              <p className="text-muted-foreground leading-relaxed">
                Automatically simplifies complex passages to appropriate reading levels while preserving academic meaning. Makes grade-level content accessible for students reading below level in English. Essential for students transitioning from survival English to academic English.
              </p>
            </div>
            ...
            <div className="bg-card border-2 border-border rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-foreground">Teacher-Student Communication</h3>
                </div>
              </div>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card border-2 border-border rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <div className="text-primary font-semibold text-sm mb-1">Tool #4</div>
                  <h3 className="text-2xl font-bold text-foreground">Academic Vocabulary Glossary</h3>
                </div>
              </div>
              <p className="text-muted-foreground leading-relaxed">
